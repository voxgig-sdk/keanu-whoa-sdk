...
// KeanuWhoa SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class KeanuWhoaTransformResponse
{
    public static function call(KeanuWhoaContext $ctx): mixed
    {
        ...
        $transform = KeanuWhoaHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
