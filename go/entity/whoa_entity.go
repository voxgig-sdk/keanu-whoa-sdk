...
type WhoaEntity struct {
	name    string
	client  *core.KeanuWhoaSDK
...
func NewWhoaEntity(client *core.KeanuWhoaSDK, entopts map[string]any) *WhoaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WhoaEntity) GetName() string { return e.name }
...
func (e *WhoaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WhoaEntity) Deleted() bool {
	return e.deleted
}


func (e *WhoaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWhoaEntity(e.client, opts)
}

func (e *WhoaEntity) Data(args ...any) any {
...
func (e *WhoaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Whoa; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WhoaEntity) DataTyped(data ...Whoa) Whoa {
	if len(data) > 0 {
		return typedFrom[Whoa](e.Data(asMap(data[0])))
	}
	return typedFrom[Whoa](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Whoa (all fields
// optional at the wire level).
func (e *WhoaEntity) MatchTyped(match ...Whoa) Whoa {
	if len(match) > 0 {
		return typedFrom[Whoa](e.Match(asMap(match[0])))
	}
	return typedFrom[Whoa](e.Match())
}
...
func (e *WhoaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WhoaEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WhoaLoadMatch and returns an Whoa. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *WhoaEntity) LoadTyped(reqmatch WhoaLoadMatch, ctrl map[string]any) (Whoa, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Whoa{}, err
	}
	return typedFrom[Whoa](res), nil
}




func (e *WhoaEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// WhoaListMatch and returns []Whoa. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *WhoaEntity) ListTyped(reqmatch WhoaListMatch, ctrl map[string]any) ([]Whoa, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Whoa](res), nil
}



func (e *WhoaEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WhoaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WhoaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WhoaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
