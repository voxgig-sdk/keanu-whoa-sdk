...
function envOverride(m) {
    if ('TRUE' === process.env.KEANU_WHOA_TEST_LIVE ||
        'TRUE' === process.env.KEANU_WHOA_TEST_OVERRIDE) {
    ...
    m.KEANU_WHOA_TEST_EXPLAIN = process.env.KEANU_WHOA_TEST_EXPLAIN || m.KEANU_WHOA_TEST_EXPLAIN;
    return m;
}
