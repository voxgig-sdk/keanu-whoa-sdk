...
class KeanuWhoaProxyFeature extends KeanuWhoaBaseFeature
{
    ...
    public function init(KeanuWhoaContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (KeanuWhoaContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
