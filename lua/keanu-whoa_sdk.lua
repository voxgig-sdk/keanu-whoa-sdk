...
local KeanuWhoaSDK = {}
KeanuWhoaSDK.__index = KeanuWhoaSDK
...
KeanuWhoaSDK._make_feature = _make_feature


function KeanuWhoaSDK.new(options)
  local self = setmetatable({}, KeanuWhoaSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function KeanuWhoaSDK:options_map()
...
function KeanuWhoaSDK:get_utility()
  return Utility.copy(self._utility)
end


function KeanuWhoaSDK:get_root_ctx()
  return self._rootctx
end


function KeanuWhoaSDK:prepare(fetchargs)
...
function KeanuWhoaSDK:direct(fetchargs)
...
-- by passing it.
function KeanuWhoaSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function KeanuWhoaSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "KeanuWhoaSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function KeanuWhoaSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = KeanuWhoaSDK.new(sdkopts)
  sdk.mode = "test"
