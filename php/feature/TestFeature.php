...
// KeanuWhoa SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class KeanuWhoaTestFeature extends KeanuWhoaBaseFeature
{
    ...
    public function init(KeanuWhoaContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (KeanuWhoaContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = KeanuWhoaParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (KeanuWhoaContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(KeanuWhoaContext $ctx, $op, $args): array
    {
