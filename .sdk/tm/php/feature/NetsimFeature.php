...
class KeanuWhoaNetsimFeature extends KeanuWhoaBaseFeature
{
    ...
    private function _simulate(KeanuWhoaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(KeanuWhoaContext $ctx, array $applied): void
    {
        $client = $this->client;
