...
describe('exists', async () => {
  ...
  //
  // KeanuWhoaSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof KeanuWhoaSDK, true,
      'KeanuWhoaSDK.test() must return a client synchronously')
  })
