...
describe('WhoaEntity', async () => {
  ...
  afterEach(liveDelay('KEANU_WHOA_TEST_LIVE'))
  ...
  test('basic', async (t) => {
    ...
    const whoa_ref01_list = (await whoa_ref01_ent.list(whoa_ref01_match)).map((e: any) => e.data())
