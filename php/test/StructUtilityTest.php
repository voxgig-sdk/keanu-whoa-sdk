...
// KeanuWhoa SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = KeanuWhoaOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(KeanuWhoaOmni::structfix($now, Struct::undef()))
                        !== json_encode(KeanuWhoaOmni::structfix($val, Struct::undef()))) {
