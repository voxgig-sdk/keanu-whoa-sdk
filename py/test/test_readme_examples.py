# KeanuWhoa SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions KeanuWhoaSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both KeanuWhoaSDK(...) and KeanuWhoaSDK.test(...) become
#      KeanuWhoaSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "keanuwhoa_sdk"
_SDK_CLASS = "KeanuWhoaSDK"
