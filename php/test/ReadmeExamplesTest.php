...
// KeanuWhoa SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (KeanuWhoaSDK::test)
...
{
    private const SDK_CLASS = 'KeanuWhoaSDK';
    ...
    private const SDK_BASE = 'keanuwhoa_sdk';
