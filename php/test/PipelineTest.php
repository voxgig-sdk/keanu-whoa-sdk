...
{
    private static function utility(): KeanuWhoaUtility
    {
        return new KeanuWhoaUtility();
    }
    ...
    private static function ctx(array $over = []): KeanuWhoaContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new KeanuWhoaContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new KeanuWhoaOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof KeanuWhoaError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new KeanuWhoaOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = KeanuWhoaMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new KeanuWhoaOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = KeanuWhoaMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new KeanuWhoaOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = KeanuWhoaMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new KeanuWhoaSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = KeanuWhoaMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new KeanuWhoaResponse([]),
            'result' => new KeanuWhoaResult([]),
        ]);
        [, $err] = KeanuWhoaMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new KeanuWhoaSpec([]),
            'response' => null,
            'result' => new KeanuWhoaResult([]),
        ]);
        [, $err] = KeanuWhoaMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new KeanuWhoaSpec(['step' => 's']),
            'response' => new KeanuWhoaResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new KeanuWhoaResult([]),
        ]);
        [, $err] = KeanuWhoaMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new KeanuWhoaSpec(['step' => 's']),
            'response' => new KeanuWhoaResponse(self::resp(200, ['v' => 1])),
            'result' => new KeanuWhoaResult([]),
        ]);
        [, $err] = KeanuWhoaMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new KeanuWhoaSpec(['step' => 's']),
            'response' => new KeanuWhoaResponse(self::resp(200, ['v' => 2])),
            'result' => new KeanuWhoaResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        KeanuWhoaMakeResponse::call($ctx);
    ...
    {
        $preset = new KeanuWhoaResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new KeanuWhoaSpec([]),
            'response' => new KeanuWhoaResponse([]),
            'result' => new KeanuWhoaResult([]),
        ...
        [$got, $err] = KeanuWhoaMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new KeanuWhoaResult([])]);
        [, $err] = KeanuWhoaMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new KeanuWhoaSpec([]), 'result' => null]);
        [, $err] = KeanuWhoaMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new KeanuWhoaSpec(['step' => 's']),
            'result' => new KeanuWhoaResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new KeanuWhoaOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = KeanuWhoaMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new KeanuWhoaSpec(['step' => 's']),
            'result' => new KeanuWhoaResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new KeanuWhoaOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = KeanuWhoaMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new KeanuWhoaResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new KeanuWhoaSpec([]),
            'result' => new KeanuWhoaResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = KeanuWhoaMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = KeanuWhoaMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new KeanuWhoaError('boom', 'boom');
        $utility->fetcher = function (KeanuWhoaContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new KeanuWhoaSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = KeanuWhoaMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (KeanuWhoaContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = KeanuWhoaMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(KeanuWhoaResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (KeanuWhoaContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new KeanuWhoaSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = KeanuWhoaMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new KeanuWhoaResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new KeanuWhoaSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = KeanuWhoaMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = KeanuWhoaMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = KeanuWhoaMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new KeanuWhoaResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, KeanuWhoaDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new KeanuWhoaResult(['ok' => false])]);
        $this->expectException(KeanuWhoaError::class);
        KeanuWhoaDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new KeanuWhoaResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', KeanuWhoaMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        KeanuWhoaMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new KeanuWhoaBaseFeature();
        $b = new KeanuWhoaBaseFeature();
        KeanuWhoaFeatureAdd::call($ctx, $a);
        KeanuWhoaFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): KeanuWhoaBaseFeature
    {
        $f = new KeanuWhoaBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        KeanuWhoaFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): KeanuWhoaContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new KeanuWhoaSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = KeanuWhoaPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new KeanuWhoaResponse(['headers' => null]),
            'result' => new KeanuWhoaResult([]),
        ]);
        KeanuWhoaResultHeaders::call($ctx);
