...
type Args struct {
	Entity string         `json:"entity" jsonschema:"whoa"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.KeanuWhoaSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "keanu-whoa_list",
		Description: "List records from KeanuWhoa. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "keanu-whoa_load",
		Description: "Load a single record from KeanuWhoa. " +
...
func runOp(client *sdk.KeanuWhoaSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.KeanuWhoaSDK, name string) (sdk.KeanuWhoaEntity, error) {
	switch strings.ToLower(name) {
	case "whoa":
		return client.Whoa(nil), nil
