...
// KeanuWhoa SDK ratelimit feature
...
class KeanuWhoaRatelimitFeature extends KeanuWhoaBaseFeature
{
    ...
    private function _acquire(KeanuWhoaContext $ctx): void
    {
    ...
    private function _track(KeanuWhoaContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
