...
local WhoaEntity = {}
WhoaEntity.__index = WhoaEntity


function WhoaEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, WhoaEntity)
  self._name = "whoa"
  self._client = client
...
function WhoaEntity:get_name()
  return self._name
end


function WhoaEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return WhoaEntity.new(self._client, opts)
end
...
function WhoaEntity:mark_deleted()
  self._deleted = true
end


function WhoaEntity:deleted()
  return true == self._deleted
end


function WhoaEntity:data_set(args)
  if args ~= nil then
...
function WhoaEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function WhoaEntity:match_set(args)
  if args ~= nil then
...
function WhoaEntity:stream(action, args, callopts)
...
function WhoaEntity:_run_op(ctx, post_done)
  local utility = self._utility
