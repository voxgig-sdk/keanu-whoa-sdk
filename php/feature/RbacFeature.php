...
class KeanuWhoaRbacFeature extends KeanuWhoaBaseFeature
{
    ...
    private function _required(KeanuWhoaContext $ctx): ?string
    {
    ...
    private function _reject(KeanuWhoaContext $ctx, string $required): void
    {
    ...
    private function _track(KeanuWhoaContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
