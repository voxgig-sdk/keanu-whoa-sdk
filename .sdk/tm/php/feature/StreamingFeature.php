...
// KeanuWhoa SDK streaming feature
...
class KeanuWhoaStreamingFeature extends KeanuWhoaBaseFeature
{
    ...
    private function _iterate(KeanuWhoaResult $result): \Generator
    {
    ...
    private function _streamable(KeanuWhoaContext $ctx): bool
    {
