...
func registerSDKWords(r *eng.Registry, client *sdk.KeanuWhoaSDK) {
...
func runOp(client *sdk.KeanuWhoaSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
