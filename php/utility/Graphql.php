...
class KeanuWhoaGraphql
{
    ...
    // equivalent.
    public static function body(KeanuWhoaContext $ctx): mixed
    {
    ...
    public static function errors(KeanuWhoaContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
