...
from keanuwhoa_sdk.utility import register

# Load features
from keanuwhoa_sdk.feature.base_feature import KeanuWhoaBaseFeature
from keanuwhoa_sdk.features import _has_feature, _make_feature
...
class KeanuWhoaSDK:
    ...
    def get_utility(self):
        return KeanuWhoaUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("KeanuWhoaSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Whoa(self, data=None) -> "WhoaEntity":
        ...
        from keanuwhoa_sdk.entity.whoa_entity import WhoaEntity
