...
|---|---|---|
| `ts/` | @voxgig-sdk/keanu-whoa-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/keanu-whoa-sdk \
      --repository voxgig-sdk/keanu-whoa-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/keanu-whoa-sdk` shows it, and
`npm trust revoke @voxgig-sdk/keanu-whoa-sdk --id=<id>` removes it.
