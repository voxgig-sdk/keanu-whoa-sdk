...
// KeanuWhoa SDK clienttrack feature
...
class KeanuWhoaClienttrackFeature extends KeanuWhoaBaseFeature
{
    ...
    public function PostConstruct(KeanuWhoaContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'KeanuWhoa-SDK';
