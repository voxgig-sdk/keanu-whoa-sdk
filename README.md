...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/keanu-whoa` | `npm install @voxgig-sdk/keanu-whoa` |
| Python | `voxgig-sdk-keanu-whoa` | `pip install voxgig-sdk-keanu-whoa` |
| PHP | `voxgig-sdk/keanu-whoa` | `composer require voxgig-sdk/keanu-whoa` |
| Golang | `github.com/voxgig-sdk/keanu-whoa-sdk/go` | `go get github.com/voxgig-sdk/keanu-whoa-sdk/go` |
| Ruby | `voxgig-sdk-keanu-whoa` | `gem install voxgig-sdk-keanu-whoa` |
| Lua | `voxgig-sdk-keanu-whoa` | `luarocks install voxgig-sdk-keanu-whoa` |
