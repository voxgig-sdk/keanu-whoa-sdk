...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = KeanuWhoaOmni.make_runner(TEST_JSON_FILE, KeanuWhoaSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : KeanuWhoaOmni.errify(err)
    end
