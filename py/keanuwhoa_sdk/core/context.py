...
from keanuwhoa_sdk.core.helpers import get_ctx_prop, to_map
...
class KeanuWhoaContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, KeanuWhoaSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, KeanuWhoaResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, KeanuWhoaResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return KeanuWhoaError(code, msg, self)
