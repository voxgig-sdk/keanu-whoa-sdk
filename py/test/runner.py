...
class KeanuWhoaTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = KeanuWhoaTestRunner.getenv("KEANUWHOA_TEST_LIVE")
        override = KeanuWhoaTestRunner.getenv("KEANUWHOA_TEST_OVERRIDE")
        ...
        explain = KeanuWhoaTestRunner.getenv("KEANUWHOA_TEST_EXPLAIN")
