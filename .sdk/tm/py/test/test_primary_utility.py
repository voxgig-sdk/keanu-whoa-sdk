...
_runner = makeRunner(TEST_JSON_FILE, KeanuWhoaSDK.test(None, None))
...
class TestPrimaryUtility:
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = KeanuWhoaSDK.test(None, setup.get('a') or {})
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = KeanuWhoaSDK.test(None, setup.get('a') or {})
