...
class KeanuWhoaTimeoutFeature extends KeanuWhoaBaseFeature
{
    ...
    private function _with_timeout(KeanuWhoaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(KeanuWhoaContext $_ctx, float $ms): void
    {
        $client = $this->client;
