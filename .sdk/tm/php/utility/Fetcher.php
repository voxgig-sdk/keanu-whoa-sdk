...
// KeanuWhoa SDK utility: fetcher

class KeanuWhoaFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; KeanuWhoaSDK/1.0)';
    ...
    public static function call(KeanuWhoaContext $ctx, string $fullurl, array $fetchdef): array
    {
