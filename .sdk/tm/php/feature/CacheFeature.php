...
class KeanuWhoaCacheFeature extends KeanuWhoaBaseFeature
{
    ...
    private function _through(KeanuWhoaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
